var Event = function(){
        ...
        $('body').on('click','.todo_update',function(evt){
            ...
            $.post(url, postData, function(o){
                if(o.result === 1){
                    ...
                    Result.error('Todo could not be saved');
                }
            },'json');
        });
    ...
    var update_note_display = function(){
        $('body').on('click','.note_update_display',function(e){
            ...
            //Populate the title and content field with the existing value
